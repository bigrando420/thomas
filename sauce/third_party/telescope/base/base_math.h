...
union Vec2F32
{
 Vec2F32(float _x = 0.0f, float _y = 0.0f) : v{_x, _y} {};
 struct
 {
  F32 x;
  F32 y;
...
struct Vec3F32
{
 Vec3F32(float _x = 0.0f, float _y = 0.0f, float _z = 0.0f)
  : x(_x), y(_y), z(_z) {}
 union
 {
  F32 x;
...
struct Vec4F32
{
 Vec4F32(float _x = 0.0f, float _y = 0.0f, float _z = 0.0f, float _w = 0.0f)
  : x(_x), y(_y), z(_z), w(_w) {}
 union
 {
  F32 x;
...
typedef struct Rng2F32 Rng2F32;
struct Rng2F32
{
 Rng2F32(float _x0 = 0.0f, float _y0 = 0.0f, float _x1 = 0.0f, float _y1 = 0.0f)
  : x0(_x0), y0(_y0), x1(_x1), y1(_y1) {};
 Rng2F32(Vec2F32 _min, Vec2F32 _max)
  : min(min), max(_max) {};
 union
 {
  struct
